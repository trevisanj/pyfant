...
def _setup_astroapi(aa):
    ...
    # TODO FileAbonds is too general; maybe leave it to the end

    aa.classes_txt.extend([pf.FileAbsoru2, pf.FileHmap, pf.FileMain, pf.FileDissoc,
                           pf.FileToH, pf.FileAbonds, pf.FileAtoms, pf.FileMolecules])

#
# _classes_bin = [FileModBin, FileSpectrumFits, FileMoo, FileFullCube, FileSparseCube,
#                 FileSpectrumList]
#
