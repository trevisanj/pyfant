...
class VisAtoms(Vis):
    ...
    def _do_use(self, r):
        ...
        form = hpd.keep_ref(pf.XFileAtoms(self.parent_form))
        form.load(r)
        form.show()
...
class VisMolecules(Vis):
    ...
    def _do_use(self, r):
        form = hpd.keep_ref(pf.XFileMolecules(self.parent_form))
        form.load(r)
        form.show()
...
class VisMain(Vis):
    ...
    def _do_use(self, r):
        form = hpd.keep_ref(pf.XFileMain(self.parent_form, r))
        form.show()
...
class VisAbonds(Vis):
    ...
    def _do_use(self, r):
        form = hpd.keep_ref(pf.XFileAbonds(self.parent_form, r))
        form.show()
