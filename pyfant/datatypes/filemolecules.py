...
import sys
import numpy as np
from hypydrive import froze_it, AttrsPart, write_lf, DataFile, float_vector,  ordinal_suffix, \
        ...
        with open(filename, "r") as h:
            ...
            try:
                ...
                for im in range(num_mol):
                    ...
                    get_python_logger().info("Loading '{}': {}".format(filename, hpd.format_progress(im+1, num_mol)))
