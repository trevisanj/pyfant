...
class FileMolDB(hpd.FileSQLiteDB):
    ...
    def _populate(self):
        ...
        for formula in formulae:
            try:
                ...
                if not symbols:
                    hpd.get_python_logger().warning("Formula '{}' not in internal BUILTIN_FORMULAS, "
                ...
                hpd.get_python_logger().exception("Failed for molecule '{}'".format(formula))
    ...
    def print_states(self, **kwargs):
        ...
        data, header0 = hpd.cursor_to_data_header(r)

        # ti = hpd.get_table_info(_ALIAS, "state")
