...
class FileDissoc(ag.DataFile):
    ...
    def _do_save_as(self, filename):
        with open(filename, "w") as h:
            ...
            ag.write_lf(h, "%5d%5d%10.5f%10.5f %s" % (self.nmetal, self.nimax, self.eps, self.switer, self.title))
            ...
            for elems, nelemx, ip, ig0, ig1, cclog in \
                ...
                ag.write_lf(h, '%2s  %6d%10.3f%5d%5d%10.5f' % (elems, nelemx, ip, ig0, ig1, cclog))
            ...
            ag.write_lf(h, "")
            ag.write_lf(h, "")  # two blank lines to signal end-of-file
