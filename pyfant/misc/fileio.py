...
"get_pyfant_data_path", "get_config_obj", "PyfantConfigObj"]
...
class PyfantConfigObj(ConfigObj):
...
def get_config_obj(filename):
    """Reads/creates filename at user home folder and returns a PyfantConfigObj object"""
    ...
    return PyfantConfigObj(path_, encoding="UTF8")
