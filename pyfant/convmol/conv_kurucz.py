...
def kurucz_to_sols(mol_row, state_row, fileobj, qgbd_calculator, flag_hlf=False, flag_normhlf=False,
    ...
    def append_error(msg):
        log.errors.append("#{}{} line: {}".format(i + 1, hpd.ordinal_suffix(i + 1), str(msg)))
    ...
    if flag_hlf:
        formulas = hpd.doublet.get_honllondon_formulas(LAML, LAM2L)
    ...
    for i, line in enumerate(lines):
        ...
        # TODO is it spin 2l?
        branch = hpd.doublet.quanta_to_branch(line.Jl, line.J2l, line.spin2l)
        try:
...
#            k *= fe
 ...
 #           fcf = 1.3201e-1
            ...
            msg = "#{}{} line: {}".format(i + 1, hpd.ordinal_suffix(i + 1), hpd.str_exc(e))
