...
class _DataSource(hpd.AttrsPart):
...
class _WSelectSaveFile(hpd.WBase):
    @property
    def value(self):
    ...
    def __init__(self, *args):
        ...
        b.setIcon(hpd.get_icon("leaf-plant"))
        ...
        b.setIcon(hpd.get_icon("document-save"))
    ...
    def edit_changed(self):
        ...
        hpd.style_widget_valid(self.edit, not flag_valid)
        # if flag_valid:
        #     self._wanna_emit()
...
class _WHitranPanel(hpd.WBase):
    ...
    def __init__(self, *args):
        ...
        w = self.w_dir = hpd.WSelectDir(self.parent_form)
    ...
    def _populate(self):
        ...
        try:
            ...
            t = self.tableWidget
            hpd.reset_table_widget(t, nr, nc)
...
class _WVald3Panel(hpd.WBase):
    ...
    def is_molecule(self):
        data = self.data
        return data is not None and data.speciess[0].formula not in hpd.symbols
    ...
    def __init__(self, *args):
        ...
        w = self.w_file = hpd.WSelectFile(self.parent_form)
        ...
        l.setStyleSheet("QLabel {{color: {}}}".format(hpd.COLOR_WARNING))
        lw.addWidget(l)
    ...
    def _populate(self):
        ...
        try:
            ...
            for i, species in enumerate(f):
                ...
                t.setItem(i, 1, item)
                item = QTableWidgetItem("Atom" if species.formula in hpd.symbols else "Molecule")
                t.setItem(i, 2, item)
            ...
            self._f = None
            self.add_log_error("Error reading contents of file '{}': '{}'".format(self.w_file.value, hpd.str_exc(e)), True)
            raise
...
class _WTurboSpectrumPanel(hpd.WBase):
    def __init__(self, *args):
        hpd.WBase.__init__(self, *args)
...
class XConvMol(hpd.XLogMainWindow):
    def __init__(self, *args):
        ...
        a = self.title_mol = QLabel(hpd.format_title0("Select a molecule:"))
        l0.addWidget(a)
        ...
        a = self.title_state = self.keep_ref(QLabel(hpd.format_title0("States")))
        l1.addWidget(a)
    ...
    def wants_auto(self):
        ...
        if filename is None:
            # Default
            filename = hpd.new_filename("mol", "dat")
    ...
    def mol_id_changed(self):
        ...
        self.title_state.setText(hpd.format_title0(s))
        ...
        try:
            ...
            if len(errors) == 0:
                ...
                if name == "HITRAN":
                    ...
                    hpd.show_message("{}-to-PFANT conversion not implemented yet, sorry".
                                    format(name))
                    return
            ...
            hpd.get_python_logger().exception("Conversion failed")
            self.add_log_error("Conversion failed: {}".format(hpd.str_exc(e)), True)
