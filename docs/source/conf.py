...
#
# (originally) F311 documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'PyFANT.tex', 'PyFANT Documentation',
...
man_pages = [
    (master_doc, 'pyfant', 'PyFANT Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyfant', 'PYFANT Documentation',
     author, 'PyFANT', 'Python interface to the PFANT spectral synthesis code + extra tools',
     'Miscellaneous'),
]
